...
namespace NavigationNetMedical.DBO
{
    ...
    public partial class HojaReclamo
    {
        ...
        public Nullable<int> i_Producto { get; set; }
        public Nullable<int> i_Servicio { get; set; }
        public string v_MontoReclamo { get; set; }
        public string v_Descripcion { get; set; }
        public Nullable<int> i_Reclamo { get; set; }
        public Nullable<int> i_Queja { get; set; }
